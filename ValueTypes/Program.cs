...
namespace ValueTypes
{
    class TypeExercise
    {
        ...
        {
            //mögliche Exception -- mögliche division durch 0
        ...
        public int BerechneAchtel(long wert)
        {
            ...
            //long max/8 : 1152921504606846976
            //int max:              2147483647
            //int min:             -2147483648
            //es tritt auch bei einem zu grossen long keine Exception auf,
            //aber es steht im int potenziell Blödsinn.
            //vllt sollten wir eine Exception implementieren...
            return (int)wert/8;
        }
