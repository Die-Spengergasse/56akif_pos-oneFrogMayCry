...
namespace Spg.Ganymed.Domain.Model
{
    public class Happening
    {
        ...
        public virtual IReadOnlyList<HappeningLocation> HappeningLocations => _happeningLocations;

        private List<CartEntry> _happeningInCartEntries = new();
        public virtual IReadOnlyList<CartEntry> HapperningInCartEntries => _happeningInCartEntries;
